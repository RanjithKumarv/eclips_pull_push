...
public class PacketCheck {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.setProperty("webdriver.chrome.driver", "E:\\Selenium\\chrome101V\\chromedriver_win32 (7)\\chromedriver.exe");
		...
		//Clicking on the Devices present in a particular block
	     ...
	     //capturing system date and time
					...
					//now we are inspecting the total water consumption in every device
					 ...
					 int waterConsumption1=Integer.parseInt(currentHour);
